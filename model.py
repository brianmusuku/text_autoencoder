...
def main():
    ...
    if len(unique_topics) >= 2:
        ...
        if len(t1_indices) > 2 and len(t2_indices) > 1:
            ...
            print(f"\nTopic [{t1}]:")
            print(f"  Sentence A: {dataset.statements[idx_A][:80]}...")
            print(f"  Sentence B: {dataset.statements[idx_B][:80]}...")
            print(f"\nTopic [{t2}]:")
            print(f"  Sentence C: {dataset.statements[idx_C][:80]}...")
